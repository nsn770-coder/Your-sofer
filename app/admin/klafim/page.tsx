...
export default function KlafimIndexPage() {
  ...
  return (
    <div dir="rtl" style={{ minHeight: '100vh', background: '#f5f5f5', fontFamily: 'Heebo, Arial, sans-serif' }}>
      {/* Header */}
      <div style={{ background: '#3B3B41', borderBottom: '3px solid #C5A028', padding: '18px 28px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 16 }}>
        <div>
              ...
              >
                <div style={{
                  ...
                  <div style={{ padding: '12px 14px' }}>
                    <div style={{ fontWeight: 800, fontSize: 13, color: '#3B3B41', marginBottom: 3, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                      {p.name}
                    </div>
                    <div style={{ fontSize: 11, color: '#888' }}>{p.cat ?? p.category}</div>
                    <div style={{
                      marginTop: 10, background: '#3B3B41', color: '#C5A028',
