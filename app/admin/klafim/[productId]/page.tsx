...
export default function KlafimProductPage() {
  ...
  return (
    <div dir="rtl" style={{ minHeight: '100vh', background: '#f5f5f5', fontFamily: 'Heebo, Arial, sans-serif' }}>
      {/* Header */}
      <div style={{ background: '#3B3B41', borderBottom: '3px solid #C5A028', padding: '18px 28px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 16, flexWrap: 'wrap' }}>
        <div>
      ...
      <div style={{ maxWidth: 1100, margin: '0 auto', padding: '28px 16px' }}>
        ...
        <div style={{ background: '#fff', borderRadius: 14, border: '1.5px solid #e8e0d0', padding: '22px 24px', marginBottom: 28 }}>
          <div style={{ fontWeight: 800, fontSize: 16, color: '#3B3B41', marginBottom: 14 }}>העלאת קלפים חדשים</div>
          ...
          >
            ...
            <div style={{ fontSize: 14, fontWeight: 700, color: '#3B3B41', marginBottom: 4 }}>גרור תמונות לכאן</div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    ...
                    <input
                      ...
                      style={{
                        ...
                        fontSize: 13, fontFamily: 'monospace', fontWeight: 700, color: '#3B3B41',
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginTop: 6 }}>
                <button
                  ...
                  disabled={saving}
                  style={{
                    background: saving ? '#888' : '#C5A028', color: '#3B3B41',
        ...
        {/* ── Existing klafim ── */}
        <div>
          <div style={{ fontWeight: 800, fontSize: 16, color: '#3B3B41', marginBottom: 14 }}>
              ...
              {klafim.map(klaf => (
                <div key={klaf.id} style={{
                  ...
                  <div style={{ padding: '8px 10px' }}>
                    <div style={{ fontFamily: 'monospace', fontSize: 11, fontWeight: 700, color: '#3B3B41', marginBottom: 4 }}>
                      {klaf.name}
                    </div>
