    ...
    <div dir="rtl">
      <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
        ...
        <button
          ...
          style={{ background: saved ? '#16a34a' : '#3B3B41', minWidth: 120 }}
        >
      ...
      <div className="mt-6 flex justify-start">
        <button
          ...
          style={{ background: saved ? '#16a34a' : '#3B3B41' }}
        >
      ...
      <div className="mt-8 bg-white rounded-xl shadow overflow-hidden">
        <div className="flex items-center justify-between p-4 border-b border-gray-100">
          ...
          <button
            ...
            disabled={heroSaving}
            className="px-5 py-2 rounded-xl font-bold text-white transition"
            style={{ background: heroSaved ? '#16a34a' : '#3B3B41', minWidth: 110 }}
          >
              ...
              >
                ...
                <div
                  style={{
                    ...
                    overflow: 'hidden', background: url ? '#000' : 'linear-gradient(135deg,#3B3B41,#1a3a2a)',
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                ...
                <div style={{ flex: 1 }}>
                  ...
                  <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                    ...
                    <button
                      ...
                      style={{
                        background: '#3B3B41', color: '#fff', border: 'none',
