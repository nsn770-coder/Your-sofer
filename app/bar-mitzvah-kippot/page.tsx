...
export const metadata: Metadata = {
  ...
  description: 'כיפות לבר מצווה בכמויות — 100 כיפות ומעלה ב-30% הנחה אוטומטית. הדפסה אישית עם שם, תאריך ולוגו. מגוון עצום, משלוח לכל הארץ, שירות מהיר.',
  keywords: [
  ...
  openGraph: {
    ...
    siteName: 'Your Sofer',
    title: 'כיפות לבר מצווה ואירועים | הדפסה אישית | Your Sofer',
    description: 'כיפות בכמויות עם הדפסה אישית. 100 כיפות ומעלה = 30% הנחה אוטומטית. Your Sofer.',
    images: [{ url: `${BASE_URL}/og-default.jpg`, width: 1200, height: 630, alt: 'כיפות לבר מצווה' }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'כיפות לבר מצווה | Your Sofer',
    description: 'כיפות בכמויות עם הדפסה אישית. 100+ כיפות = 30% הנחה.',
...
export const FAQ_ITEMS = [
  ...
  {
    q: 'האם יש הנחה לכמויות?',
    a: 'כן! בהזמנה של 100 כיפות ומעלה תקבלו 30% הנחה אוטומטית על כל הכיפות בהזמנה. ההנחה מחושבת אוטומטית — אין צורך בקוד קופון.',
  },
  {
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            description: 'כיפות לבר מצווה בכמויות עם הדפסה אישית. 100 כיפות ומעלה = 30% הנחה.',
            url: PAGE_URL,
