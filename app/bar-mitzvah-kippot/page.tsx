...
// התוכן מגיע ממקור האמת המרכזי (data/faq.ts) — אין לנהל כאן תשובות ידנית,
// כדי שלא ייווצרו סתירות מול דף ה-FAQ, הבוט ושאר העמודים.

export const FAQ_ITEMS = [
  {
    q: 'כמה כיפות צריך לבר מצווה?',
    a: 'בדרך כלל מזמינים כיפה אחת לכל מוזמן. אירוע ממוצע דורש בין 80 ל-200 כיפות. מומלץ להזמין 10–15% עודף ליתר ביטחון — למשפחה, לצלמים ולאורחים.',
  },
  ...getFaqForPage('event-kippot', 8).map(item => ({
    q: item.question,
    a: item.fullAnswer,
  })),
];
