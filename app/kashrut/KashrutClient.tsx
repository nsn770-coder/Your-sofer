      ...
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '40px 16px 60px' }}>
        ...
        <div style={{ background: '#fff', border: '1px solid #e8e0d0', borderRadius: 12, overflow: 'hidden', marginBottom: 24 }}>
          <div style={{ padding: '24px 24px 0', display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <h2 style={{ fontSize: 18, fontWeight: 800, color: 'var(--ys-text)', margin: 0 }}>תעודת כשרות</h2>
          </div>
          ...
          <div style={{ padding: '14px 24px 24px' }}>
            <button
              ...
              style={{
                ...
                background: 'var(--ys-dark-surface)', color: '#fff',
        ...
        <h2 style={{ color: 'var(--ys-text)', fontSize: 20, fontWeight: 800, margin: '0 0 16px' }}>תהליך הבדיקה</h2>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(180px, 1fr))', gap: 14, marginBottom: 32 }}>
          {PROCESS.map(step => (
            <div key={step.title} style={{ background: '#fff', border: '1px solid #e8e0d0', borderRadius: 10, padding: '20px 16px', textAlign: 'center' }}>
              ...
              <div style={{ fontWeight: 800, fontSize: 14, color: 'var(--ys-text)', marginBottom: 6 }}>{step.title}</div>
        ...
        <div style={{ background: '#fff', border: '1px solid #e8e0d0', borderRadius: 12, padding: '28px 24px', marginBottom: 24 }}>
          <h2 style={{ fontSize: 18, fontWeight: 800, color: 'var(--ys-text)', margin: '0 0 20px' }}>המגיה שלנו</h2>
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: 18 }}>
            <img
              ...
              style={{
                ...
                border: '3px solid var(--ys-accent)', flexShrink: 0,
              }}
            />
            <div>
              <div style={{ fontWeight: 800, fontSize: 16, color: 'var(--ys-text)', marginBottom: 3 }}>
                הרב שמחה בונים ברג׳יקובסקי
              </div>
              <div style={{ fontSize: 13, color: 'var(--ys-accent)', fontWeight: 700, marginBottom: 10 }}>
                רב מגיה מוסמך
              </div>
              ...
              <div style={{
                ...
                borderRadius: 20, padding: '4px 12px', fontSize: 11, fontWeight: 700, color: 'var(--ys-accent)',
              }}>
        ...
        {/* Commitment box */}
        <div style={{ background: 'rgba(184,151,42,0.08)', border: '2px solid var(--ys-accent)', borderRadius: 10, padding: '24px 28px', textAlign: 'center' }}>
          <div style={{ fontSize: 28, marginBottom: 8 }}>✡️</div>
          <div style={{ fontSize: 17, fontWeight: 800, color: 'var(--ys-text)', marginBottom: 6 }}>
