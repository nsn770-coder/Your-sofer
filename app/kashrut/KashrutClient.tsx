      ...
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '40px 16px 60px' }}>
        ...
        <div style={{ background: '#fff', border: '1px solid #e8e0d0', borderRadius: 12, overflow: 'hidden', marginBottom: 24 }}>
          <div style={{ padding: '24px 24px 0', display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <h2 style={{ fontSize: 18, fontWeight: 800, color: '#1a1a1a', margin: 0 }}>תעודת כשרות</h2>
          </div>
        ...
        <h2 style={{ color: '#1a1a1a', fontSize: 20, fontWeight: 800, margin: '0 0 16px' }}>תהליך הבדיקה</h2>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(180px, 1fr))', gap: 14, marginBottom: 32 }}>
          {PROCESS.map(step => (
            <div key={step.title} style={{ background: '#fff', border: '1px solid #e8e0d0', borderRadius: 10, padding: '20px 16px', textAlign: 'center' }}>
              ...
              <div style={{ fontWeight: 800, fontSize: 14, color: '#1a1a1a', marginBottom: 6 }}>{step.title}</div>
        ...
        <div style={{ background: '#fff', border: '1px solid #e8e0d0', borderRadius: 12, padding: '28px 24px', marginBottom: 24 }}>
          <h2 style={{ fontSize: 18, fontWeight: 800, color: '#1a1a1a', margin: '0 0 20px' }}>המגיה שלנו</h2>
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: 18 }}>
            ...
            />
            <div>
              <div style={{ fontWeight: 800, fontSize: 16, color: '#1a1a1a', marginBottom: 3 }}>
        ...
        <div style={{ background: 'rgba(184,151,42,0.08)', border: '2px solid #C5A028', borderRadius: 10, padding: '24px 28px', textAlign: 'center' }}>
          ...
          <div style={{ fontSize: 17, fontWeight: 800, color: '#1a1a1a', marginBottom: 6 }}>
