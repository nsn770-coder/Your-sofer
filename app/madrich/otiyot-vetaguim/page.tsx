...
export const metadata: Metadata = {
  title: 'סודות האותיות והתגים בסת"ם',
  description:
    'מה זה תגים? למה יש לאותיות מסוימות כתרים? המשמעות ההלכתית של צורות האותיות בסת"ם וכיצד זה משפיע על הכשרות.',
...
const articleSchema = {
  ...
  description: 'הסבר על תגים, כתרים, וצורות האותיות בסת"ם – מה הם ולמה הם חשובים.',
  url: `${BASE_URL}/madrich/otiyot-vetaguim`,
      ...
      <ArticleLayout>
        ...
        <div style={{ padding: '40px 0' }}>
          ...
          <p style={{ fontSize: 17, lineHeight: 1.8, color: '#333', marginBottom: 24 }}>
            כאשר מסתכלים על קלף מזוזה מקרוב, ניתן לראות שרוב האותיות נראות מוכרות – אבל חלקן מקושטות בקווים קטנים בראשן. אלו הם ה"תגים" – אחד ממאפייני הסת"ם שרוב האנשים לא יודעים עליהם.
          </p>
          ...
          <p style={{ fontSize: 16, lineHeight: 1.8, color: '#444', marginBottom: 16 }}>
            תגים (מארמית: "כתרים") הם קווים קטנים שנמשכים כלפי מעלה מראש האות. הם אינם חלק מצורת האות הבסיסית, אלא הידור נוסף שמסורתו עוד ממשה רבנו.
          </p>
          <p style={{ fontSize: 16, lineHeight: 1.8, color: '#444', marginBottom: 16 }}>
            יש שתי מסורות עיקריות לתגים: תגי "שעטנ"ז ג"ץ" (שבע אותיות שמקבלות שלושה תגים כל אחת) ותגי "אותיות יש ביאה" (אותיות נוספות עם תג אחד). בנוסח האר"י יש מערכת תגים שונה מעט.
          </p>
          ...
          <p style={{ fontSize: 16, lineHeight: 1.8, color: '#444', marginBottom: 16 }}>
            שבע האותיות שי"ן, עי"ן, טי"ת, נו"ן, זיי"ן, גימ"ל, צדי"ק – מקבלות שלושה תגים כל אחת. אלו התגים החשובים ביותר, ומחסורם אינו פוסל את הכתיבה אך מהווה פחות הידור.
          </p>
          ...
          <p style={{ fontSize: 16, lineHeight: 1.8, color: '#444', marginBottom: 16 }}>
            לכל אות עברית בסת"ם יש צורה מדויקת שנקבעה בהלכה. שינוי בצורת האות – גם אם קטן – יכול לפסול אותה. למשל: ה"ד" ו"ר" דומות, אבל שונות; ה"ב" ו"כ" דומות, אבל שונות.
          </p>
          ...
          <p style={{ fontSize: 16, lineHeight: 1.8, color: '#444', marginBottom: 16 }}>
            המגיה (בודק הסת"ם) עובר על כל אות בהגדלה, בודק שכל צורת אות תקינה, שהתגים במקומם, ושאין אות שנגעה באות אחרת (נגיעה פוסלת). בדיקה מקצועית לוקחת מספר שעות לכל קלף.
          </p>
          ...
          <FAQItem q='מה ההבדל בין תגים לכתב?' a='הכתב הוא צורת האות עצמה (שמשפיעה על הכשרות); התגים הם הוספות קטנות מעל האות (השפעה על ההידור).' />
