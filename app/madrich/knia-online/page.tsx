        ...
        <div style={{ padding: '40px 0' }}>
          ...
          {[
            ...
            <div key={item.num} style={{ display: 'flex', gap: 16, marginBottom: 20, padding: '16px', background: '#fff', borderRadius: 8, border: '1px solid #e0e0e0' }}>
              <div style={{ background: 'var(--ys-dark-surface)', color: 'var(--ys-accent)', fontWeight: 900, fontSize: 18, minWidth: 40, height: 40, borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>{item.num}</div>
              <div>
