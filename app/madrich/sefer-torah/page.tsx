...
export const metadata: Metadata = {
  ...
  description:
    'מדריך מקיף להזמנת ספר תורה: 304,805 אותיות, כמה זמן לוקח, מה המחיר, איך בוחרים סופר, ניהול הפרויקט, ומה ההבדל בין כתיבה חדשה לשיפוץ.',
  ...
  openGraph: {
    ...
    description: 'מדריך להזמנת ספר תורה – תהליך, עלות, ניהול פרויקט, ובחירת סופר.',
  },
};
...
const articleSchema = {
  ...
  description: 'מדריך מקיף להזמנת ספר תורה חדש, ניהול הפרויקט, או שיפוץ ספר תורה ישן.',
  url: `${BASE_URL}/madrich/sefer-torah`,
    ...
    <>
      ...
      <ArticleLayout>
        <PageHero
          ...
          subtitle="לפני שמזמינים – תהליך, עלות, ניהול פרויקט ובחירת הסופר הנכון"
        />

        <div style={{ padding: '40px 0' }}>

          <p style={{ fontSize: 17, lineHeight: 1.8, color: '#333', marginBottom: 24 }}>
            כתיבת ספר תורה היא המצווה האחרונה מתוך תרי"ג מצוות שבתורה – "וְעַתָּה כִּתְבוּ לָכֶם אֶת הַשִּׁירָה הַזֹּאת". מדובר בפרויקט משמעותי שדורש תכנון מראש, הבנה של התהליך, ובחירה מושכלת של סופר. ספר תורה מכיל בדיוק 304,805 אותיות – כל אחת נכתבת בידי הסופר עם כוונה מיוחדת.
          </p>
          ...
          <p style={{ fontSize: 16, lineHeight: 1.8, color: '#444', marginBottom: 16 }}>
            כתיבת ספר תורה שלם לוקחת בין 9 ל-14 חודשים לפחות, ולעיתים עד שלוש שנים, תלוי בסופר ובדרגת ההידור. ספר תורה שנכתב בפחות מחצי שנה – עשוי להעיד על פשרה משמעותית באיכות.
          </p>
          <p style={{ fontSize: 16, lineHeight: 1.8, color: '#444', marginBottom: 16 }}>
          ...
          <p style={{ fontSize: 16, lineHeight: 1.8, color: '#444', marginBottom: 16 }}>
            מחיר ספר תורה חדש נע בין 25,000 ל-120,000 ש"ח ומעלה. פערי המחיר נובעים משלושה רכיבים עיקריים:
          </p>
          {[
            { title: 'רמת הסופר וניסיונו', desc: 'סופר מהשורה הראשונה כותב לאט, משקיע בכל תג ותג, ומייצר יצירת אמנות. כתב פשוט ומהיר מול כתב מהודר מאוד שלוקח שלוש פעמים יותר זמן.' },
            { title: 'סוג הנוסח', desc: 'כתב בית יוסף וכתב האר"י לוקחים יותר זמן מכתב ספרדי. ספרי תורה אשכנזיים וחסידיים יקרים יותר בדרך כלל.' },
            { title: 'איכות הקלף', desc: 'קלף עבודת יד מול קלף מכונה – הבדל משמעותי במחיר ובאיכות לאורך זמן.' },
          ...
          <Step num={2} title="בחירת מפרט" desc="קלף עבודת יד או מכונה? נוסח הכתיבה? רמת ההידור? הגדירו את הדרישות מראש ורשמו הכל בחוזה." />
          <Step num={3} title="חוזה ולוח זמנים" desc="חתמו על הסכם ברור שכולל תאריך יעד, מחיר כולל, ביטוח יריעות, ואפשרות לביקורות ביניים. כספי התרומות כדאי לשחרר לסופר בשלבים, רק לאחר אישור מקצועי." />
          <Step num={4} title="מעקב ובדיקות" desc="בקשו עדכונים תקופתיים (סריקות של יריעות שנכתבו). שלחו לבדיקת מגיה מוסמך לפחות פעמיים במהלך הכתיבה." />
          ...
          <FAQItem q='האם ספר תורה שנרכש מהאינטרנט כשר?' a='תלוי לחלוטין בסופר ובפיקוח. חשוב לוודא שהסופר מוסמך, לבקש אישור מגיה, ולוודא שהספר נבדק כראוי לפני קבלתו.' />
