  ...
  if (notFound || !cert) {
    return (
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', fontFamily: 'Heebo, Arial, sans-serif', gap: 12 }}>
        ...
        <div style={{ fontSize: 20, fontWeight: 700, color: 'var(--ys-text)' }}>תעודה לא נמצאה</div>
  ...
  return (
    <>
      ...
      <div className="no-print" style={{
        ...
        background: 'var(--ys-dark-surface)', padding: '10px 24px',
        display: 'flex', alignItems: 'center', justifyContent: 'space-between',
        gap: 12, flexWrap: 'wrap',
      }}>
        <span style={{ color: 'var(--ys-accent)', fontWeight: 700, fontFamily: 'Heebo, Arial, sans-serif', fontSize: 14 }}>
          ...
          {cert.customerEmail && (
            <button
              ...
              style={{
                ...
                color: emailSent ? '#fff' : 'var(--ys-accent)',
      ...
      <div style={{
        ...
        <div id="certificate" dir="rtl" style={{
          ...
          // Double gold border
          border: '3px solid var(--ys-accent)',
          outline: '8px solid rgba(184,151,42,0.15)',
          outlineOffset: '-12px',
        }}>

          {/* ── Header ── */}
          <div style={{ textAlign: 'center', paddingBottom: 14, marginBottom: 18, borderBottom: '2.5px solid var(--ys-accent)' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 14, marginBottom: 8 }}>
              <span style={{ fontSize: 26, color: 'var(--ys-accent)' }}>✡</span>
              <div>
                <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: '0.22em', color: 'var(--ys-text)', textTransform: 'uppercase' }}>
            ...
            <div style={{ fontSize: 30, fontWeight: 900, color: 'var(--ys-text)', letterSpacing: '0.02em' }}>
              תעודת כשרות סת״מ
            </div>
          ...
          <div style={{ textAlign: 'center', marginBottom: 22 }}>
            ...
            <p style={{ fontSize: 24, fontWeight: 900, color: 'var(--ys-text)', margin: '0 0 6px' }}>
              {cert.customerName}
            </p>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', marginBottom: 22, fontSize: 11 }}>
            <thead>
              <tr style={{ background: 'var(--ys-dark-surface)', color: '#fff' }}>
            ...
            <tbody>
              {cert.items.map((item, i) => (
                <tr key={i} style={{ background: i % 2 === 0 ? '#fffdf8' : '#fff', borderBottom: '1px solid #e8e0d0' }}>
                  <td style={{ padding: '7px 10px', fontFamily: 'monospace', color: 'var(--ys-text)', fontWeight: 700, letterSpacing: '0.04em', whiteSpace: 'nowrap' }}>
                    {item.serialNumber}
                  </td>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 22 }}>
            <div>
              ...
              <div style={{ fontSize: 15, fontWeight: 800, color: 'var(--ys-text)' }}>{cert.magiaName}</div>
            ...
            <div style={{ textAlign: 'left' }}>
              ...
              <div style={{ fontSize: 15, fontWeight: 700, color: 'var(--ys-text)' }}>{dateStr}</div>
          ...
          {/* ── Footer ── */}
          <div style={{
            borderTop: '2px solid var(--ys-accent)',
            paddingTop: 14,
            display: 'flex',
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ fontSize: 15, fontWeight: 900, fontFamily: 'monospace', color: 'var(--ys-text)', letterSpacing: '0.06em' }}>
                {cert.certId}
              </div>
