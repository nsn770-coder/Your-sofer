  ...
  if (notFound || !cert) {
    return (
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', fontFamily: 'Heebo, Arial, sans-serif', gap: 12 }}>
        ...
        <div style={{ fontSize: 20, fontWeight: 700, color: '#1a1a1a' }}>תעודה לא נמצאה</div>
      ...
      <div className="no-print" style={{
        ...
        <div style={{ display: 'flex', gap: 8, alignItems: 'center', flexWrap: 'wrap' }}>
          ...
          <button
            ...
            style={{
              background: '#C5A028', color: '#1a1a1a', border: 'none',
        ...
        <div id="certificate" dir="rtl" style={{
          ...
          <div style={{ textAlign: 'center', paddingBottom: 14, marginBottom: 18, borderBottom: '2.5px solid #C5A028' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 14, marginBottom: 8 }}>
              ...
              <div>
                <div style={{ fontSize: 11, fontWeight: 700, letterSpacing: '0.22em', color: '#1a1a1a', textTransform: 'uppercase' }}>
          ...
          <div style={{ textAlign: 'center', marginBottom: 22 }}>
            ...
            <p style={{ fontSize: 24, fontWeight: 900, color: '#1a1a1a', margin: '0 0 6px' }}>
              {cert.customerName}
            </p>
            ...
            <tbody>
              {cert.items.map((item, i) => (
                <tr key={i} style={{ background: i % 2 === 0 ? '#fffdf8' : '#fff', borderBottom: '1px solid #e8e0d0' }}>
                  <td style={{ padding: '7px 10px', fontFamily: 'monospace', color: '#1a1a1a', fontWeight: 700, letterSpacing: '0.04em', whiteSpace: 'nowrap' }}>
                    {item.serialNumber}
                  </td>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 22 }}>
            <div>
              ...
              <div style={{ fontSize: 15, fontWeight: 800, color: '#1a1a1a' }}>{cert.magiaName}</div>
            ...
            <div style={{ textAlign: 'left' }}>
              ...
              <div style={{ fontSize: 15, fontWeight: 700, color: '#1a1a1a' }}>{dateStr}</div>
          ...
          <div style={{
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ fontSize: 15, fontWeight: 900, fontFamily: 'monospace', color: '#1a1a1a', letterSpacing: '0.06em' }}>
                {cert.certId}
              </div>
