  ...
  if (notFound || !cert) {
    return (
      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', fontFamily: 'Heebo, Arial, sans-serif', gap: 12 }}>
        ...
        <div style={{ fontSize: 20, fontWeight: 700, color: '#0c1a35' }}>תעודה לא נמצאה</div>
      ...
      <div style={{
        ...
        <div id="certificate" dir="rtl" style={{
          ...
          <div style={{ textAlign: 'center', marginBottom: 22 }}>
            ...
            <p style={{ fontSize: 24, fontWeight: 900, color: '#0c1a35', margin: '0 0 6px' }}>
              {cert.customerName}
            </p>
            ...
            <tbody>
              {cert.items.map((item, i) => (
                <tr key={i} style={{ background: i % 2 === 0 ? '#fffdf8' : '#fff', borderBottom: '1px solid #e8e0d0' }}>
                  <td style={{ padding: '7px 10px', fontFamily: 'monospace', color: '#0c1a35', fontWeight: 700, letterSpacing: '0.04em', whiteSpace: 'nowrap' }}>
                    {item.serialNumber}
                  </td>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 22 }}>
            <div>
              ...
              <div style={{ fontSize: 15, fontWeight: 800, color: '#0c1a35' }}>{cert.magiaName}</div>
            ...
            <div style={{ textAlign: 'left' }}>
              ...
              <div style={{ fontSize: 15, fontWeight: 700, color: '#0c1a35' }}>{dateStr}</div>
          ...
          <div style={{
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ fontSize: 15, fontWeight: 900, fontFamily: 'monospace', color: '#0c1a35', letterSpacing: '0.06em' }}>
                {cert.certId}
              </div>
