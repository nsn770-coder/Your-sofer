...
const FAQS = [
  ...
  },
  {
    ...
    a: 'משלוח עד הבית: בדרך כלל 7-10 ימי עסקים, ₪35. משלוחים יוצאים בימי שני וחמישי. מוצרי הדפסה אישית: עד 10 ימי עסקים.\nבצרכים דחופים מיוחדים ניתן לפנות בוואטסאפ לפני ההזמנה — לעיתים נוכל לספק תוך כ-4 ימים, ללא התחייבות.\nניתן גם לאסוף עצמאית בדימונה בתיאום מוקדם.',
  },
  {
  ...
  {
    q: 'יש לכם חנות פיזית?',
    a: 'אין חנות פיזית פתוחה לקהל הרחב, אך ניתן לתאם פגישה אישית בדימונה. צרו קשר בטלפון 058-4877-770, וואטסאפ 058-747-9933 או באימייל support@your-sofer.com.',
  },
  {
  ...
  {
    q: 'כיצד ניתן לשלם?',
    a: 'ניתן לשלם בכרטיס אשראי (ויזה, מאסטרקארד, אמריקן אקספרס), עם אפשרות לפריסה של עד 3 תשלומים ללא ריבית. התשלום מאובטח ומוצפן. פרטי הכרטיס אינם נשמרים על שרתינו.',
  },
  {
    ...
    <div style={{ minHeight: '100vh', background: '#f3f4f4', direction: 'rtl', fontFamily: 'Heebo, Arial, sans-serif' }}>
      ...
      <div style={{ maxWidth: 820, margin: '32px auto', padding: '0 16px 48px' }}>
        <div style={{ background: '#fff', borderRadius: 14, padding: '32px 28px', boxShadow: '0 2px 12px rgba(0,0,0,0.07)' }}>
          <h1 style={{ fontSize: 26, fontWeight: 900, color: '#1a1a1a', marginBottom: 6 }}>שאלות נפוצות</h1>
          ...
          <div style={{ marginTop: 32, padding: '18px 20px', background: '#f0f4ff', border: '1px solid #c8d4f0', borderRadius: 10 }}>
            <p style={{ fontSize: 14, fontWeight: 700, color: '#1a1a1a', margin: '0 0 6px' }}>לא מצאת תשובה?</p>
