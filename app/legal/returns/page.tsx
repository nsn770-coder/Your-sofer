  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f3f4f4', direction: 'rtl', fontFamily: 'Heebo, Arial, sans-serif' }}>
      <div style={{ background: 'var(--ys-dark-surface)', padding: '16px 20px', display: 'flex', alignItems: 'center', gap: 12 }}>
        <button onClick={() => router.back()} style={{ background: 'none', border: 'none', color: 'var(--ys-accent)', fontSize: 20, cursor: 'pointer' }}>←</button>
      ...
      <div style={{ maxWidth: 820, margin: '32px auto', padding: '0 16px 48px' }}>
        <div style={{ background: '#fff', borderRadius: 14, padding: '32px 28px', boxShadow: '0 2px 12px rgba(0,0,0,0.07)' }}>
          <h1 style={{ fontSize: 26, fontWeight: 900, color: 'var(--ys-text)', marginBottom: 6 }}>מדיניות החזרים</h1>
          ...
          <div style={{ marginBottom: 24 }}>
            ...
            <ul style={{ fontSize: 14, color: '#444', lineHeight: 2, margin: '0 0 14px', paddingRight: 20, listStyle: 'disc' }}>
              <li>אימייל: <a href="mailto:support@your-sofer.com" style={{ color: 'var(--ys-text)', fontWeight: 700 }}>support@your-sofer.com</a></li>
              <li>טלפון: <a href="tel:0584877770" style={{ color: 'var(--ys-text)', fontWeight: 700 }}>058-4877-770</a></li>
              <li>וואטסאפ: <a href="https://wa.me/972587479933" style={{ color: 'var(--ys-text)', fontWeight: 700 }}>058-747-9933</a></li>
