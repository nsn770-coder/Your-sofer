...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Your Sofer - אתר היודאיקה הגדול בישראל | כיפות, מתנות ומזכרות לאירועים',
    template: '%s | Your Sofer',
  },
  description:
    'אתר היודאיקה הגדול בישראל עם מעל 6,000 מוצרים: כיפות בעיצוב אישי, מזכרות ומתנות לאירועים, תיקי טלית ותפילין, תשמישי קדושה, כלי שולחן ומוצרים לבית היהודי. משלוחים לכל הארץ.',
  keywords: [
  ...
  twitter: {
    ...
    title: 'Your Sofer - אתר היודאיקה הגדול בישראל',
    description: 'מעל 6,000 מוצרי יודאיקה: כיפות בעיצוב אישי, מזכרות ומתנות לאירועים.',
