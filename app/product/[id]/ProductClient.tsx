...
function ProductContentSections({ product }: { product: Product }) {
  ...
  const useCases = isStam
    ? [
        { emoji: '🏠', text: 'כניסה לבית חדש — מצווה ראשונה שמקדשת את הבית' },
        { emoji: '🎁', text: 'מתנה לחתונה או בר מצווה שתישאר לדורות' },
        { emoji: '✡️', text: 'מי שמחפש קלף כשר עם שקיפות מלאה על הסופר' },
      ]
    : [
