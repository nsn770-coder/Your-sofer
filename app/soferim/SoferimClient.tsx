...
export default function SoferimClient() {
      ...
      <div style={{ maxWidth: 1100, margin: '24px auto', padding: '0 16px' }}>
        ...
        {loading ? (
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: 20, paddingBottom: 40 }}>
            {filtered.map(s => (
              <div key={s.id}
                onClick={() => router.push(`/soferim/${s.id}`)}
                style={{ background: '#fff', borderRadius: 12, overflow: 'hidden', boxShadow: '0 2px 8px rgba(0,0,0,0.08)', border: '1px solid #eee', transition: 'box-shadow 0.2s', cursor: 'pointer' }}
