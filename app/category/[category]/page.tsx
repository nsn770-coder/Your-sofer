...
const CATEGORY_META: Record<string, CategoryMetaEntry> = {
  ...
  'מזוזות': {
    ...
    description: 'מזוזות כשרות לרכישה מקוונת - בתי מזוזה מעץ, מתכת, זכוכית ועוד. כל קלף מצולם, נבדק ומקושר לסופר שכתב אותו. משלוח לכל הארץ.',
  },
  'יודאיקה': {
  ...
  'כלי שולחן והגשה': {
    title: 'כלי שולחן והגשה - מגשים, קערות, כוסות וגביעים',
    description: 'מגוון כלי שולחן והגשה: מגשים, קערות, כוסות, גביעים, בקבוקים וקנקנים. עיצוב יהודי לשולחן שבת ולכל אירוע. Your Sofer.',
  },
  'הגשה ואירוח': {
    title: 'הגשה ואירוח - כלי הגשה, מגשים, קערות וגביעים',
    description: 'מגוון כלי הגשה ואירוח: מגשים, קערות, כוסות, גביעים, בקבוקים וקנקנים. עיצוב יהודי לשולחן שבת ולכל אירוע. Your Sofer.',
  },
  'עיצוב הבית': {
    title: 'עיצוב הבית - פמוטים, שעונים, קישוטים ודקור לבית',
    description: 'פריטי עיצוב לבית: פמוטים ונרות, שעונים, קופסאות, מסגרות, קישוטים ודקור. מתנות ייחודיות לכל אירוע. Your Sofer.',
  },
};
