...
const CATEGORY_META: Record<string, { title: string; description: string }> = {
  'מזוזות': {
    title: 'מזוזות כשרות ומהודרות — קלפים מסופרים מוסמכים',
    description: 'מזוזות כשרות ומהודרות לרכישה מקוונת. כל קלף מצולם, נבדק ומקושר לסופר שכתב אותו. משלוח חינם לכל הארץ.',
  },
  'כיסוי תפילין': {
  ...
  'תפילין קומפלט': {
    ...
    description: 'תפילין קומפלט לכל הנוסחים — אשכנז, ספרד, חב"ד ותימני. קלף כתוב בידי סופר מוסמך, בדוק לפני מכירה.',
  },
  'טליתות': {
    title: 'טליתות — טלית קטן וטלית גדולה',
    description: 'טליתות צמר, משי ופוליאסטר — טלית קטן וטלית גדולה לכל הגדלים. Your Sofer.',
  },
  'מגילות': {
  ...
  'יודאיקה': {
    ...
    description: 'מוצרי יודאיקה: חנוכיות, כוסות קידוש, נרות ועוד. מתנות ייחודיות לכל אירוע. Your Sofer.',
  },
  'מתנות': {
  ...
  'בר מצווה': {
    title: 'מתנות ומוצרים לבר מצווה — תפילין, טלית וסטים',
    description: 'סטים לבר מצווה: תפילין, טלית, כיסויים ומתנות מיוחדות. הכל במקום אחד. Your Sofer.',
  },
  'חגים ומועדים': {
    title: 'מוצרים לחגים ומועדים — ראש השנה, יום כיפור, פסח ועוד',
    description: 'מוצרי סת"מ ויודאיקה לחגים ומועדים: ראש השנה, יום כיפור, סוכות, פסח ועוד. Your Sofer.',
  },
  'קלפים': {
    title: 'קלפי מזוזה ותפילין — כתיבה ידנית מסופרים',
    description: 'קלפי מזוזה וקלפי תפילין כתובים בידי סופר סת"מ מוסמך. כל קלף מצולם ונבדק. Your Sofer.',
  },
  'קלפי מזוזה': {
