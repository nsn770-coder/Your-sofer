...
export const SUB_CATS: Record<string, string[]> = {
  ...
  'כלי שולחן והגשה':     ['מגשים', 'כוסות', 'צלחות וקערות', 'קנקנים', 'ספלים', 'מערכות אוכל', 'כלי אכילה', 'מפיות', 'כלי הגשה'],
  'עיצוב הבית':           ['פמוטים', 'אגרטלים', 'מראות', 'נרות ריחניים', 'עציצים', 'מסגרות תמונה', 'מעמדות לנר', 'קישוטים', 'עיטורים וזרים', 'צנצנות', 'תלייה וקולבים', 'קופסאות תכשיטים', 'אביזרי בית'],
};
