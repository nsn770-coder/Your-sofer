    ...
    columns: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: "סט תפילין תרמי",  cat: "סט טלית תפילין", filter: "תיקים טרמי" },
          { label: "סט תפילין",       cat: "סט טלית תפילין", filter: "תיקי עור מדומה" },
          { label: "בתי תפילין",      cat: "סט טלית תפילין", filter: "בתי תפילין" },
          { label: 'רש"י ר"ת',        cat: "סט טלית תפילין", filter: "רש\"י ר\"ת" },
        ]
      },
      {
        title: "קלפי תפילין",
    ...
    columns: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: "קיטלים", cat: "יודאיקה", filter: "קיטלים" },
    ...
    columns: [
      {
        ...
        items: [
          ...
          { label: "קרשי חלה", cat: "שבת", filter: "קרשי חלה" },
          { label: "מלחיות", cat: "שבת", filter: "מלחיות" },
          { label: "כיסויי פלטה", cat: "שבת", filter: "כיסויי פלטה" },
          { label: "מחלקי יין", cat: "כלי שולחן והגשה", filter: "מחלקי יין" },
        ]
      },
    ],
  },
    ...
    columns: [
      {
        ...
        items: [
          ...
          { label: "תכשיטים", cat: "תכשיטים", filter: "תכשיטים" },
          { label: "צמידים וטבעות", cat: "תכשיטים", filter: "צמידים וטבעות" },
          { label: "תכשיטי כסף", cat: "תכשיטים", filter: "תכשיטי כסף" },
          { label: "נירוסטה ורודיום", cat: "תכשיטים", filter: "נירוסטה ורודיום" },
        ]
      },
    ],
  },
    ...
    columns: [
      {
        ...
        items: [
          ...
          { label: "מוצרי בית כנסת", cat: "מוצרי בית כנסת", filter: "מוצרי בית כנסת" },
        ]
      },
    ],
  },
