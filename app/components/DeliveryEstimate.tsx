...
function IconTruckSmall({ size = 18, color = 'var(--ys-heading)' }: { size?: number; color?: string }) {
  return (
    ...
    <div dir="rtl" style={{
      ...
      <div style={{ minWidth: 0 }}>
        ...
        <div style={{ fontSize: compact ? 10.5 : 11, color: '#555', marginTop: 2 }}>
          ...
          {' '}
          <Link href={POLICY_URLS.shipping} style={{ color: 'var(--ys-heading)', textDecorationLine: 'underline', textDecorationColor: '#93b8e8', textUnderlineOffset: 2 }}>
            מידע על משלוחים
          </Link>
        </div>
      </div>
