  ...
  return (
    <>
      ...
      {isOpen && (
        <div className="shira-window" dir="rtl">
          ...
          <div className="shira-wa-bar">
            <a href="https://wa.me/972584877770" target="_blank" rel="noopener noreferrer" className="shira-wa-btn">
      ...
      <style jsx global>{`
        ...
        .shira-product-price { font-size: 14px; font-weight: 900; color: #1a1a1a; white-space: nowrap; }
        .shira-product-cta {
        ...
        /* WhatsApp human-agent bar */
        .shira-wa-bar {
          padding: 8px 14px 10px; background: white;
          border-top: 1px solid #f0ebe3; flex-shrink: 0; text-align: center;
        }
        .shira-wa-btn {
