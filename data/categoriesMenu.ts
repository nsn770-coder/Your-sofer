    ...
    columns: [
      {
        ...
        items: [
          ...
          { label: "ברכות לתלייה",   cat: "יודאיקה", filter: "ברכות לתלייה" },
          { label: "מעמדים וסטנדים", cat: "יודאיקה", filter: "מעמדים וסטנדים" },
    ...
    columns: [
      ...
      },
      {
        ...
        items: [
          ...
          { label: "ראש השנה",         cat: "ספרי קודש וברכונים", filter: "ראש השנה" },
          { label: "חנוכה",            cat: "ספרי קודש וברכונים", filter: "חנוכה" },
          { label: "פורים",            cat: "ספרי קודש וברכונים", filter: "פורים" },
          { label: "פסח",              cat: "ספרי קודש וברכונים", filter: "פסח" },
        ],
      },
    ],
  },
