...
export const FAQ_ITEMS: FAQItem[] = [
  ...
  },
  {
    ...
    fullAnswer:
      ...
      '• 30–99 יחידות: 12 ₪ ליחידה.\n' +
      '• 100–299 יחידות: 10 ₪ ליחידה.\n' +
      '• 300 יחידות ומעלה: 9 ₪ ליחידה.\n\n' +
      'דוגמאות:\n' +
      '• 30 כיפות פשתן: 360 ₪.\n' +
      '• 100 כיפות פשתן: 1,000 ₪.\n' +
      '• 300 כיפות פשתן: 2,700 ₪.\n\n' +
      `מחיר המשלוח (${SHIP_COST}) אינו כלול במחיר הכיפות.`,
    shortAnswer:
      'כיפות פשתן כולל הדפסה: 30–99 יח׳ — 12 ₪ ליחידה; 100–299 יח׳ — 10 ₪ ליחידה; 300 ומעלה — 9 ₪ ליחידה. המשלוח אינו כלול.',
