...
export const FAQ_ITEMS: FAQItem[] = [
  ...
  },
  {
    ...
    fullAnswer:
      ...
      '• 30–49 יחידות: 15 ₪ ליחידה.\n' +
      '• 50–99 יחידות: 14 ₪ ליחידה.\n' +
      '• 100–199 יחידות: 12 ₪ ליחידה.\n' +
      '• 200 יחידות ומעלה: 10 ₪ ליחידה.\n\n' +
      'דוגמאות:\n' +
      '• 30 כיפות פשתן: 450 ₪.\n' +
      '• 100 כיפות פשתן: 1,200 ₪.\n' +
      '• 200 כיפות פשתן: 2,000 ₪.\n\n' +
      `מחיר המשלוח (${SHIP_COST}) אינו כלול במחיר הכיפות.`,
    shortAnswer:
      'כיפות פשתן כולל הדפסה: 30–49 יח׳ — 15 ₪ ליחידה; 50–99 יח׳ — 14 ₪ ליחידה; 100–199 יח׳ — 12 ₪ ליחידה; 200 ומעלה — 10 ₪ ליחידה. המשלוח אינו כלול.',
